...
const About = () => {
    ...
    <>
        ...
        className="w-full px-5 py-10 gap-20 md:px-20 flex flex-col items-center justify-center md:flex-row bg-equiprGray overflow-hidden">  
            ...
            <h2 className="font-bold text-3xl md:text-4xl ">Empowering Young Minds to Shape Tomorrow's World</h2>
            <p className="text-sm mt-3"> At Equipr, we are on a mission to unlock the untapped potential of young leaders globally. We connect ambitious minds with tools, opportunities, and environments that foster growth, innovation, and impact.
                <br /> <br />
