...
const About = () => {
    return (
    <>
        <div className="w-full h-96 px-20 flex flex-col items-center justify-center md:flex-row bg-equiprGray">  
            {/* First Section */}
            <div className="w-1/2 flex justify-center items-center">jdjdjdj</div>
